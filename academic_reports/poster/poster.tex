...
\begin{figure}[H]
\includegraphics{plots/shared}
\caption{\label{p:shared} Energy efficiency of shared sensors across different devices. The order of energy efficiency differs depending on a device e.g. Bluetooth is the most energy efficient sensor for HTC Desire and HTC Flyer, but not for Google Nexus 7. }
\end{figure}

\begin{figure}[H]
\includegraphics{plots/acc_vs_loc}
\caption{\label{p:acc_vs_loc} Energy efficiency levels of IEEE 802.11, GPS and accelerometer sensors across different devices. Acceleromter is more energy-efficient, but the difference is not substantial, and thus, efficient accelerometer sampling strategies needs to be introduced. }
\end{figure}
...
\begin{figure}[H]
\includegraphics{plots/locy_eval_inplace}
...
\begin{figure}[H]
\includegraphics{plots/locy_eval_other}
